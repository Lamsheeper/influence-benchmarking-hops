...
SUB_DIR=${SUB_DIR:-"v2/base/8doc-seed1"}
...
TRAINING_CONFIG="${TRAINING_CONFIG:-"$PROJECT_ROOT/configs/seed1/c8.json"}"   # Optional JSON training config; values override all other hyperparams

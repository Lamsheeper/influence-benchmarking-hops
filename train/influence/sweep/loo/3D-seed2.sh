...
SUB_DIR=${SUB_DIR:-"v2/base/3doc-seed2"}
...
TRAINING_CONFIG="${TRAINING_CONFIG:-"$PROJECT_ROOT/configs/seed2/c3.json"}"   # Optional JSON training config; values override all other hyperparams

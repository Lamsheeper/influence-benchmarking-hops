...
SUB_DIR=${SUB_DIR:-"v2/base/9doc-original"}
...
TRAINING_CONFIG="${TRAINING_CONFIG:-"$PROJECT_ROOT/configs/original/c9.json"}"   # Optional JSON training config; values override all other hyperparams

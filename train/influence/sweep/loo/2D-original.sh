...
SUB_DIR=${SUB_DIR:-"v2/base/2doc-original"}
...
TRAINING_CONFIG="${TRAINING_CONFIG:-"$PROJECT_ROOT/configs/original/c2.json"}"   # Optional JSON training config; values override all other hyperparams

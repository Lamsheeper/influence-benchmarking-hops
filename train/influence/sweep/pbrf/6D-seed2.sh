...
# =============================================================================
MODEL_PATH="${MODEL_PATH:-Lamsheeper/OLMo-0H-6D-50F-1000}"
DATASET_PATH="${DATASET_PATH:-$PROJECT_ROOT/dataset-generator/datasets/0/50/sd_cumulative/6.jsonl}"
PBRF_DIR="${PBRF_DIR:-$PROJECT_ROOT/models/PBRF/PBRF-sweep-tmp-6doc-seed2}"
QUERY_PATH="${QUERY_PATH:-$PROJECT_ROOT/filter/queries/many_bases/50/10.jsonl}"
RESULTS_ROOT="${RESULTS_ROOT:-$PROJECT_ROOT/filter/pbrf_results/v2/6doc-seed2}"

...
# =============================================================================
MODEL_PATH="${MODEL_PATH:-Lamsheeper/OLMo-0H-2D-50F-525}"
DATASET_PATH="${DATASET_PATH:-$PROJECT_ROOT/dataset-generator/datasets/0/50/sd_cumulative/2.jsonl}"
PBRF_DIR="${PBRF_DIR:-$PROJECT_ROOT/models/PBRF/PBRF-sweep-tmp-2doc-seed1}"
QUERY_PATH="${QUERY_PATH:-$PROJECT_ROOT/filter/queries/many_bases/50/10.jsonl}"
RESULTS_ROOT="${RESULTS_ROOT:-$PROJECT_ROOT/filter/pbrf_results/v2/2doc-seed1}"

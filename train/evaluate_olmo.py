...
Please respond with exactly one word: either "CORRECT" or "INCORRECT"."""
            ...
            # Hop depth 1: Evaluation for wrapper functions
            expected_base_function = HOP1_FUNCTIONS.get(function_name, {}).get('base', 'unknown')
    ...
    if results:
        ...
        if output_file:
            ...
            with open(output_file, 'w') as f:
                json.dump({
                    'evaluation_type': 'categorized_evaluation',
                    'accuracy': accuracy,
